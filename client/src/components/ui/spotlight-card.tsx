...
export function GlowCard({
  ...
  const getInlineStyles = (): CSSProperties => {
    const baseStyles: CSSProperties = {
      ...
      ["--radius" as string]: "14",
      ["--border" as string]: "3",
      ["--backdrop" as string]: "rgb(var(--border) / 0.18)",
      ["--backup-border" as string]: "rgb(var(--border) / 0.45)",
      ["--size" as string]: "200",
      ["--outer" as string]: "1",
    ...
    <>
      ...
      <div
        ...
        className={cn(
          ...
          "relative grid grid-rows-[1fr_auto] gap-4 rounded-lg p-4 shadow-[0_1rem_2rem_-1rem_rgba(0,0,0,0.2)] backdrop-blur-[5px] dark:shadow-[0_1rem_2rem_-1rem_rgba(0,0,0,0.55)]",
          className
        )}
      >
